	...
	public static void main(String[] args) {
		...
		종료: while (true) {
			...
			case 1:
				 ...
				 * 
				 * if(kor1 < 0 || 100 < kor1) { System.out.println("성적 범위(0 ~ 100)를 벗어났습니다"); }
				 * } while (kor1 < 0 || 100 < kor1); // while 구문의 조건이 참이면 다시 do 코드로 돌아감
				 * 
				 * do { System.out.print("국어2: "); kor2 = scan.nextInt();
				 * 
				 * if(kor2 < 0 || 100 < kor2) { System.out.println("성적 범위(0 ~ 100)를 벗어났습니다"); }
				 * } while(kor2 < 0 || 100 < kor2);
				 * 
				 * do { System.out.print("국어3: "); kor3 = scan.nextInt();
				 * 
				 * if(kor3 < 0 || 100 < kor3) { System.out.println("성적 범위(0 ~ 100)를 벗어났습니다"); }
